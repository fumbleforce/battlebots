...
low faceted hull, continuous angled hood and thick ram blade, flared blade wings,
...
- `flamebot_07.blend`: editable Blender 5.2.1 source with packed textures, seven
  individually editable mechanical parts under moving assembly pivots, studio
...
- `flamebot_07_hero.png`, `flamebot_07_rear.png`, `flamebot_07_side.png` and
  `flamebot_07_front.png`: front/rear beauty renders and orthographic checks.
...
color maps, four packed roughness/metallic maps, and four plain materials).
Edge chips and scrapes are localized around armor seams instead of uniform noise.
...
Blender rebuilt and saved the source and GLB successfully. Front/rear/side Cycles
renders inspected. The geometry builder asserts positive wheel/hull, tread/arch,
blade-flare/tire and external flamer-mount/tower clearances; measurements are
...
checks wheel extents and measures the external flamer boss's clearance. Results
...
materials, widened wheel pivot positions, meter scale, Y-up/-Z-forward and absence
